...
print("Amount of collisions in first 12 bits: ", num_collisions)
print("Collisions:")
...
print(f"\n\n\nAverage amount of changed bits: {average_differences}")
print(f"Probability:{average_differences/256}")
